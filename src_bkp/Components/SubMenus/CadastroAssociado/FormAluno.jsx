...
function FormAluno({
  ...
  console.log("associado[indiceAssociado]._id",associado[indiceAssociado]._id)
  ...
  const registraPresenca = () => {
    setObjPresenca({
      "nomeAluno": nomealuno,
      "Idaluno": id,
      "dataPresenca": new Date().toLocaleDateString('pt-BR'),
    })
      ...
      {associado.length > 0 && indiceAssociado <= associado.length && (
        <Form className="formA">
          ...
          <div className="editA">
            ...
            <Button className="editarBtn" variant="outline-warning" onClick={alteraAluno}>
              {segundoIncluiSalvar}
